...
executables = [cx_Freeze.Executable("mynotepad.py", base=base, icon="icon.ico")]


cx_Freeze.setup(
    name = "My Notebook",
    options = {"build_exe": {"packages":["tkinter","os"], "include_files":["icon.ico",'tcl86t.dll','tk86t.dll', 'software']}},
    version = "0.01",
